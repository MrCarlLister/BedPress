 ...
 * @return void
 */
function ee_mph__acf_register_video_block()
{
    ...
    acf_register_block_type(array(
        'name'                => $block_name,
        'title'                => __('Video', get_bloginfo('name')),
        'description'        => __('Display a video block'),
        'category'            => 'common',
        'icon'                => 'playlist-video',
...
add_action('acf/init', 'ee_mph__acf_register_video_block');
