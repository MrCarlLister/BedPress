 ...
 * @return void
 */
function ee_mph__acf_register_newsletter_block() {
	...
	acf_register_block_type( array(
		'name'				=> $block_name,
		'title'				=> __( 'Newsletter', get_bloginfo('name') ),
		'description'		=> __( 'Display the newsletter sign up form' ),
		'category'			=> 'common',
		'icon'				=> 'list-view',
		'keywords'			=> array( 'form', 'newsletter', 'subscribe' ),
...
add_action('acf/init', 'ee_mph__acf_register_newsletter_block' );
