 ...
 * @return void
 */
function ee_mph__acf_register_promo_block() {
	...
	acf_register_block_type( array(
		'name'				=> $block_name,
		'title'				=> __( 'Promotional messaging', get_bloginfo('name') ),
		'description'		=> __( 'Display a message with media and call to action' ),
		'category'			=> 'common',
		'icon'				=> 'align-wide',
		'keywords'			=> array( 'image', 'promo', 'text', 'call to action' ),
...
add_action('acf/init', 'ee_mph__acf_register_promo_block' );
