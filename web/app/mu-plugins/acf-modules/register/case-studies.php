 ...
 * @return void
 */
function ee_mph__acf_register_case_studies_block() {
	
	if( ! function_exists( 'acf_register_block_type' ) )
		return;

	$block_name = 'case-studies';
	$render_template = ee_mph__acf_find_the_template_path($block_name);

	acf_register_block_type( array(
		'name'				=> $block_name,
		'title'				=> __( 'Case studies', get_bloginfo('name') ),
		'description'		=> __( 'Display all Case studies' ),
		'category'			=> 'common',
		'icon'				=> 'chart-pie',
...
add_action('acf/init', 'ee_mph__acf_register_case_studies_block' );
