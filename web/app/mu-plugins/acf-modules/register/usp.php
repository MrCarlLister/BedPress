 ...
 * @return void
 */
function ee_mph__acf_register_usp_block() {
	...
	acf_register_block_type( array(
		'name'				=> $block_name,
		'title'				=> __( 'Unique Selling Points', get_bloginfo('name') ),
		'description'		=> __( 'Display USPs' ),
		'category'			=> 'common',
		'icon'				=> 'star-filled',
		'keywords'			=> array( 'usp', 'unique selling points', 'why us' ),
...
add_action('acf/init', 'ee_mph__acf_register_usp_block' );
