 ...
 * @return void
 */
function ee_mph__acf_register_articles_block() {
	...
	acf_register_block_type( array(
		'name'				=> $block_name,
		'title'				=> __( 'Articles', get_bloginfo('name') ),
		'description'		=> __( 'Display all articles' ),
		'category'			=> 'common',
		'icon'				=> 'format-aside',
...
add_action('acf/init', 'ee_mph__acf_register_articles_block' );
