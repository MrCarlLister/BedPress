 ...
 * @return void
 */
function ee_mph__acf_register_related_block() {
	...
	acf_register_block_type( array(
		'name'				=> $block_name,
		'title'				=> __( 'Related content', get_bloginfo('name') ),
		'description'		=> __( 'Display related content' ),
		'category'			=> 'common',
		'icon'				=> 'images-alt',
		'keywords'			=> array( 'articles', 'products', 'related' ),
...
add_action('acf/init', 'ee_mph__acf_register_related_block' );
